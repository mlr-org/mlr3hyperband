...
* mlr3book chapter on [hyperband](https://mlr3book.mlr-org.com/hyperband.html)
and [hyperparameter tuning](https://mlr3book.mlr-org.com/tuning.html).
...
For this, several brackets are constructed with an associated set of configurations for
each bracket.
These configuration are initialized by stochastic, often
uniform, sampling.
