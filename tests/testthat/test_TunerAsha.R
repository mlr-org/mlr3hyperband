...
test_that("TunerAsha works with minimum budget > 1", {
  learner = lrn("classif.debug",
    x  = to_tune(),
...
test_that("TunerAsha works with custom sampler", {
  learner = lrn("classif.debug",
    x  = to_tune(),
    iter = to_tune(p_int(1, 4, tags = "budget"))
  )
  ...
  test_tuner_asha(eta = 2, learner, sampler = sampler)
})

test_that("TunerAsha errors if not enough parameters are sampled", {
  learner = lrn("classif.debug",
    x  = to_tune(),
...
test_that("TunerAsha errors if budget parameter is sampled", {
  learner = lrn("classif.debug",
    x  = to_tune(),
    iter = to_tune(p_int(1, 4, tags = "budget"))
  )
...
test_that("TunerAsha errors if budget parameter is not numeric", {
  learner = lrn("classif.debug",
    x  = to_tune(),
...
test_that("TunerAsha errors if multiple budget parameters are set", {
  learner = lrn("classif.debug",
...
test_that("TunerAsha minimizes measure", {
  learner = lrn("classif.debug",
    x = to_tune(),
    iter = to_tune(p_int(1, 16, tags = "budget"))
  )
...
test_that("TunerAsha maximizes measure", {
  learner = lrn("classif.debug",
    x = to_tune(),
    iter = to_tune(p_int(1, 16, tags = "budget"))
  )
...
test_that("TunerAsha works with single budget value", {
  learner = lrn("classif.debug",
    x  = to_tune(),
