...
test_that("TunerBatchSuccessiveHalving adjusts minimum budget", {
  learner = lrn("classif.debug", x = to_tune(), iter = to_tune(p_int(1, 30, tags = "budget")))
...
test_that("TunerBatchSuccessiveHalving minimizes measure", {
  ...
  instance = test_tuner_successive_halving(
    n = 16,
    eta = 2,
    learner,
...
test_that("TunerBatchSuccessiveHalving works with r_max > n", {
  learner = lrn("classif.debug", x = to_tune(), iter = to_tune(p_int(1, 17, tags = "budget")))

  test_tuner_successive_halving(n = 16, eta = 2, learner)
})

test_that("TunerBatchSuccessiveHalving works with r_max < n", {
  learner = lrn("classif.debug", x = to_tune(), iter = to_tune(p_int(1, 15, tags = "budget")))
